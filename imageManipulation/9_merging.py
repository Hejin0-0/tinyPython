...
panda = Image.open('imageManipulation/image/picture.jpg').convert('RGBA')
owl = Image.open('imageManipulation/image/owl.jpg') # same size as panda image
python = Image.open('imageManipulation/image/python.png') # smaller than the panda image + has transparency
